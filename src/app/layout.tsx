...
export const metadata: Metadata = {
  title: "Sidekick·",
  description: "Every great founder has a sidekick. Walk in with a vision. Walk out with a plan.",
  keywords: ["startup", "founder", "business plan", "idea", "sidekick"],
  authors: [{ name: "Sidekick" }],
  openGraph: {
    title: "Sidekick·",
    description: "Walk in with a vision. Walk out with a plan.",
    type: "website",
  },
};
